...
func (_BasSubDomain *BasSubDomainCaller) Sub(opts *bind.CallOpts, arg0 [32]byte) (struct {
	...
	outstruct.TotalName = out[0].([]byte)
	outstruct.RootHash = out[1].([32]byte)
