...
// GetSettingParam is a free data retrieval call binding the contract method 0x6d9ad782.
//
// Solidity: function getSettingParam() view returns(uint256, uint256, uint256)
func (_ColdBoot *ColdBootCaller) GetSettingParam(opts *bind.CallOpts) (*big.Int, *big.Int, *big.Int, error) {
	var out []interface{}
	err := _ColdBoot.contract.Call(opts, &out, "getSettingParam")
...
//
// Solidity: function getSettingParam() view returns(uint256, uint256, uint256)
func (_ColdBoot *ColdBootSession) GetSettingParam() (*big.Int, *big.Int, *big.Int, error) {
	return _ColdBoot.Contract.GetSettingParam(&_ColdBoot.CallOpts)
}

// GetSettingParam is a free data retrieval call binding the contract method 0x6d9ad782.
//
// Solidity: function getSettingParam() view returns(uint256, uint256, uint256)
func (_ColdBoot *ColdBootCallerSession) GetSettingParam() (*big.Int, *big.Int, *big.Int, error) {
	return _ColdBoot.Contract.GetSettingParam(&_ColdBoot.CallOpts)
}

// GetTokenList is a free data retrieval call binding the contract method 0x41b63bd8.
//
// Solidity: function getTokenList(uint256 idx_) view returns(bool, uint256, uint8)
func (_ColdBoot *ColdBootCaller) GetTokenList(opts *bind.CallOpts, idx_ *big.Int) (bool, *big.Int, uint8, error) {
	var out []interface{}
...
//
// Solidity: function getTokenList(uint256 idx_) view returns(bool, uint256, uint8)
func (_ColdBoot *ColdBootSession) GetTokenList(idx_ *big.Int) (bool, *big.Int, uint8, error) {
...
//
// Solidity: function getTokenList(uint256 idx_) view returns(bool, uint256, uint8)
func (_ColdBoot *ColdBootCallerSession) GetTokenList(idx_ *big.Int) (bool, *big.Int, uint8, error) {
	return _ColdBoot.Contract.GetTokenList(&_ColdBoot.CallOpts, idx_)
}
...
// OpenTime is a free data retrieval call binding the contract method 0xb4256888.
//
// Solidity: function openTime() view returns(uint256)
func (_ColdBoot *ColdBootCaller) OpenTime(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _ColdBoot.contract.Call(opts, &out, "openTime")
...
//
// Solidity: function openTime() view returns(uint256)
func (_ColdBoot *ColdBootSession) OpenTime() (*big.Int, error) {
	return _ColdBoot.Contract.OpenTime(&_ColdBoot.CallOpts)
}

// OpenTime is a free data retrieval call binding the contract method 0xb4256888.
//
// Solidity: function openTime() view returns(uint256)
func (_ColdBoot *ColdBootCallerSession) OpenTime() (*big.Int, error) {
	return _ColdBoot.Contract.OpenTime(&_ColdBoot.CallOpts)
}
...
func (_ColdBoot *ColdBootTransactor) SetName(opts *bind.TransactOpts, name_ string, symbol_ string) (*types.Transaction, error) {
	return _ColdBoot.contract.Transact(opts, "setName", name_, symbol_)
}

// SetName is a paid mutator transaction binding the contract method 0x5c707f07.
//
// Solidity: function setName(string name_, string symbol_) returns()
func (_ColdBoot *ColdBootSession) SetName(name_ string, symbol_ string) (*types.Transaction, error) {
	return _ColdBoot.Contract.SetName(&_ColdBoot.TransactOpts, name_, symbol_)
}

// SetName is a paid mutator transaction binding the contract method 0x5c707f07.
//
// Solidity: function setName(string name_, string symbol_) returns()
func (_ColdBoot *ColdBootTransactorSession) SetName(name_ string, symbol_ string) (*types.Transaction, error) {
	return _ColdBoot.Contract.SetName(&_ColdBoot.TransactOpts, name_, symbol_)
}

// SetOpenTime is a paid mutator transaction binding the contract method 0xf60ba338.
//
// Solidity: function setOpenTime(uint256 openTime_) returns()
func (_ColdBoot *ColdBootTransactor) SetOpenTime(opts *bind.TransactOpts, openTime_ *big.Int) (*types.Transaction, error) {
	return _ColdBoot.contract.Transact(opts, "setOpenTime", openTime_)
}

// SetOpenTime is a paid mutator transaction binding the contract method 0xf60ba338.
//
// Solidity: function setOpenTime(uint256 openTime_) returns()
func (_ColdBoot *ColdBootSession) SetOpenTime(openTime_ *big.Int) (*types.Transaction, error) {
	return _ColdBoot.Contract.SetOpenTime(&_ColdBoot.TransactOpts, openTime_)
}

// SetOpenTime is a paid mutator transaction binding the contract method 0xf60ba338.
//
// Solidity: function setOpenTime(uint256 openTime_) returns()
func (_ColdBoot *ColdBootTransactorSession) SetOpenTime(openTime_ *big.Int) (*types.Transaction, error) {
	return _ColdBoot.Contract.SetOpenTime(&_ColdBoot.TransactOpts, openTime_)
}
