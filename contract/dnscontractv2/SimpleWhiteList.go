...
// SimpleWhiteListMetaData contains all meta data concerning the SimpleWhiteList contract.
var SimpleWhiteListMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint8\",\"name\":\"\",\"type\":\"uint8\"}],\"name\":\"EvAddWhiteAddr\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"name\":\"EvAddWhiteDefault\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":false,\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"indexed\":false,\"internalType\":\"uint8\",\"name\":\"\",\"type\":\"uint8\"}],\"name\":\"EvUpdateWhiteAddr\",\"type\":\"event\"},{\"inputs\":[{\"internalType\":\"address[]\",\"name\":\"addrs\",\"type\":\"address[]\"}],\"name\":\"AddMultiWhiteAddr\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"user_\",\"type\":\"address\"},{\"internalType\":\"uint8\",\"name\":\"level_\",\"type\":\"uint8\"}],\"name\":\"AddWhiteAddress\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"user_\",\"type\":\"address\"}],\"name\":\"IsAWhiteMember\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"user_\",\"type\":\"address\"}],\"name\":\"LevelAddr\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"Operator\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"op\",\"type\":\"address\"}],\"name\":\"SetOperator\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"user_\",\"type\":\"address\"},{\"internalType\":\"uint8\",\"name\":\"level_\",\"type\":\"uint8\"}],\"name\":\"UpdateWhiteAddress\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"defaultLevel\",\"outputs\":[{\"internalType\":\"uint8\",\"name\":\"\",\"type\":\"uint8\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"addresspayable\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint8\",\"name\":\"cnt_\",\"type\":\"uint8\"}],\"name\":\"setDefaultLevel\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"addresspayable\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"name\":\"whiteAddrList\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"isDefault\",\"type\":\"bool\"},{\"internalType\":\"uint256\",\"name\":\"cnt\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}

// SimpleWhiteListABI is the input ABI used to generate the binding from.
// Deprecated: Use SimpleWhiteListMetaData.ABI instead.
var SimpleWhiteListABI = SimpleWhiteListMetaData.ABI
...
// IsAWhiteMember is a free data retrieval call binding the contract method 0x6427eef6.
//
// Solidity: function IsAWhiteMember(address user_) view returns(bool)
func (_SimpleWhiteList *SimpleWhiteListCaller) IsAWhiteMember(opts *bind.CallOpts, user_ common.Address) (bool, error) {
	var out []interface{}
	err := _SimpleWhiteList.contract.Call(opts, &out, "IsAWhiteMember", user_)
...
//
// Solidity: function IsAWhiteMember(address user_) view returns(bool)
func (_SimpleWhiteList *SimpleWhiteListSession) IsAWhiteMember(user_ common.Address) (bool, error) {
	return _SimpleWhiteList.Contract.IsAWhiteMember(&_SimpleWhiteList.CallOpts, user_)
}

// IsAWhiteMember is a free data retrieval call binding the contract method 0x6427eef6.
//
// Solidity: function IsAWhiteMember(address user_) view returns(bool)
func (_SimpleWhiteList *SimpleWhiteListCallerSession) IsAWhiteMember(user_ common.Address) (bool, error) {
	return _SimpleWhiteList.Contract.IsAWhiteMember(&_SimpleWhiteList.CallOpts, user_)
}

// LevelAddr is a free data retrieval call binding the contract method 0x5767c0e1.
//
// Solidity: function LevelAddr(address user_) view returns(uint256)
func (_SimpleWhiteList *SimpleWhiteListCaller) LevelAddr(opts *bind.CallOpts, user_ common.Address) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function LevelAddr(address user_) view returns(uint256)
func (_SimpleWhiteList *SimpleWhiteListSession) LevelAddr(user_ common.Address) (*big.Int, error) {
...
//
// Solidity: function LevelAddr(address user_) view returns(uint256)
func (_SimpleWhiteList *SimpleWhiteListCallerSession) LevelAddr(user_ common.Address) (*big.Int, error) {
	return _SimpleWhiteList.Contract.LevelAddr(&_SimpleWhiteList.CallOpts, user_)
}
...
func (_SimpleWhiteList *SimpleWhiteListCaller) Operator(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SimpleWhiteList.contract.Call(opts, &out, "Operator")
...
//
// Solidity: function Operator() view returns(address)
func (_SimpleWhiteList *SimpleWhiteListSession) Operator() (common.Address, error) {
	return _SimpleWhiteList.Contract.Operator(&_SimpleWhiteList.CallOpts)
}

// Operator is a free data retrieval call binding the contract method 0x2dd07fbc.
//
// Solidity: function Operator() view returns(address)
func (_SimpleWhiteList *SimpleWhiteListCallerSession) Operator() (common.Address, error) {
	return _SimpleWhiteList.Contract.Operator(&_SimpleWhiteList.CallOpts)
}

// DefaultLevel is a free data retrieval call binding the contract method 0x29b56f01.
//
// Solidity: function defaultLevel() view returns(uint8)
func (_SimpleWhiteList *SimpleWhiteListCaller) DefaultLevel(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _SimpleWhiteList.contract.Call(opts, &out, "defaultLevel")
...
//
// Solidity: function defaultLevel() view returns(uint8)
func (_SimpleWhiteList *SimpleWhiteListSession) DefaultLevel() (uint8, error) {
	return _SimpleWhiteList.Contract.DefaultLevel(&_SimpleWhiteList.CallOpts)
}

// DefaultLevel is a free data retrieval call binding the contract method 0x29b56f01.
//
// Solidity: function defaultLevel() view returns(uint8)
func (_SimpleWhiteList *SimpleWhiteListCallerSession) DefaultLevel() (uint8, error) {
	return _SimpleWhiteList.Contract.DefaultLevel(&_SimpleWhiteList.CallOpts)
}
...
// WhiteAddrList is a free data retrieval call binding the contract method 0x3c3d7022.
//
// Solidity: function whiteAddrList(address ) view returns(bool isDefault, uint256 cnt)
func (_SimpleWhiteList *SimpleWhiteListCaller) WhiteAddrList(opts *bind.CallOpts, arg0 common.Address) (struct {
	IsDefault bool
	Cnt       *big.Int
}, error) {
	var out []interface{}
	err := _SimpleWhiteList.contract.Call(opts, &out, "whiteAddrList", arg0)
	...
	outstruct.IsDefault = *abi.ConvertType(out[0], new(bool)).(*bool)
	outstruct.Cnt = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
...
//
// Solidity: function whiteAddrList(address ) view returns(bool isDefault, uint256 cnt)
func (_SimpleWhiteList *SimpleWhiteListSession) WhiteAddrList(arg0 common.Address) (struct {
	IsDefault bool
	Cnt       *big.Int
}, error) {
	return _SimpleWhiteList.Contract.WhiteAddrList(&_SimpleWhiteList.CallOpts, arg0)
}

// WhiteAddrList is a free data retrieval call binding the contract method 0x3c3d7022.
//
// Solidity: function whiteAddrList(address ) view returns(bool isDefault, uint256 cnt)
func (_SimpleWhiteList *SimpleWhiteListCallerSession) WhiteAddrList(arg0 common.Address) (struct {
	IsDefault bool
	Cnt       *big.Int
}, error) {
	return _SimpleWhiteList.Contract.WhiteAddrList(&_SimpleWhiteList.CallOpts, arg0)
...
//
// Solidity: function SetOperator(address op) returns()
func (_SimpleWhiteList *SimpleWhiteListTransactor) SetOperator(opts *bind.TransactOpts, op common.Address) (*types.Transaction, error) {
	return _SimpleWhiteList.contract.Transact(opts, "SetOperator", op)
}

// SetOperator is a paid mutator transaction binding the contract method 0xdbebfba6.
//
// Solidity: function SetOperator(address op) returns()
func (_SimpleWhiteList *SimpleWhiteListSession) SetOperator(op common.Address) (*types.Transaction, error) {
	return _SimpleWhiteList.Contract.SetOperator(&_SimpleWhiteList.TransactOpts, op)
}

// SetOperator is a paid mutator transaction binding the contract method 0xdbebfba6.
//
// Solidity: function SetOperator(address op) returns()
func (_SimpleWhiteList *SimpleWhiteListTransactorSession) SetOperator(op common.Address) (*types.Transaction, error) {
	return _SimpleWhiteList.Contract.SetOperator(&_SimpleWhiteList.TransactOpts, op)
}
...
// SimpleWhiteListEvAddWhiteDefaultIterator is returned from FilterEvAddWhiteDefault and is used to iterate over the raw logs and unpacked data for EvAddWhiteDefault events raised by the SimpleWhiteList contract.
type SimpleWhiteListEvAddWhiteDefaultIterator struct {
	Event *SimpleWhiteListEvAddWhiteDefault // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *SimpleWhiteListEvAddWhiteDefaultIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(SimpleWhiteListEvAddWhiteDefault)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *SimpleWhiteListEvAddWhiteDefaultIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *SimpleWhiteListEvAddWhiteDefaultIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// SimpleWhiteListEvAddWhiteDefault represents a EvAddWhiteDefault event raised by the SimpleWhiteList contract.
type SimpleWhiteListEvAddWhiteDefault struct {
	Arg0 common.Address
	Arg1 common.Address
	Arg2 bool
	Raw  types.Log // Blockchain specific contextual infos
...
// FilterEvAddWhiteDefault is a free log retrieval operation binding the contract event 0x881af853ba92cdb5e1e95fac34f2e5a5cd518974d540ca03d037363b5d1dc314.
//
// Solidity: event EvAddWhiteDefault(address arg0, address arg1, bool arg2)
func (_SimpleWhiteList *SimpleWhiteListFilterer) FilterEvAddWhiteDefault(opts *bind.FilterOpts) (*SimpleWhiteListEvAddWhiteDefaultIterator, error) {

	logs, sub, err := _SimpleWhiteList.contract.FilterLogs(opts, "EvAddWhiteDefault")
	if err != nil {
		return nil, err
	}
	return &SimpleWhiteListEvAddWhiteDefaultIterator{contract: _SimpleWhiteList.contract, event: "EvAddWhiteDefault", logs: logs, sub: sub}, nil
}

// WatchEvAddWhiteDefault is a free log subscription operation binding the contract event 0x881af853ba92cdb5e1e95fac34f2e5a5cd518974d540ca03d037363b5d1dc314.
//
// Solidity: event EvAddWhiteDefault(address arg0, address arg1, bool arg2)
func (_SimpleWhiteList *SimpleWhiteListFilterer) WatchEvAddWhiteDefault(opts *bind.WatchOpts, sink chan<- *SimpleWhiteListEvAddWhiteDefault) (event.Subscription, error) {

	logs, sub, err := _SimpleWhiteList.contract.WatchLogs(opts, "EvAddWhiteDefault")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(SimpleWhiteListEvAddWhiteDefault)
				if err := _SimpleWhiteList.contract.UnpackLog(event, "EvAddWhiteDefault", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseEvAddWhiteDefault is a log parse operation binding the contract event 0x881af853ba92cdb5e1e95fac34f2e5a5cd518974d540ca03d037363b5d1dc314.
//
// Solidity: event EvAddWhiteDefault(address arg0, address arg1, bool arg2)
func (_SimpleWhiteList *SimpleWhiteListFilterer) ParseEvAddWhiteDefault(log types.Log) (*SimpleWhiteListEvAddWhiteDefault, error) {
	event := new(SimpleWhiteListEvAddWhiteDefault)
	if err := _SimpleWhiteList.contract.UnpackLog(event, "EvAddWhiteDefault", log); err != nil {
		return nil, err
	}
