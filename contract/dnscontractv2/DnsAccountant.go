...
func (_DnsAccountant *DnsAccountantCaller) MultiSignerStore(opts *bind.CallOpts, arg0 common.Address) (struct {
	...
	outstruct.Work = out[0].(bool)
	outstruct.Lock = out[1].(bool)
	outstruct.SignerCount = out[2].(*big.Int)
