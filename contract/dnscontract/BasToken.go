...
// BasTokenMetaData contains all meta data concerning the BasToken contract.
var BasTokenMetaData = &bind.MetaData{
...
// Deprecated: Use BasTokenMetaData.ABI instead.
var BasTokenABI = BasTokenMetaData.ABI
