...
func (_BasRootDomain *BasRootDomainCaller) Root(opts *bind.CallOpts, arg0 [32]byte) (struct {
	...
	outstruct.RootName = *abi.ConvertType(out[0], new([]byte)).(*[]byte)
	outstruct.OpenToPublic = *abi.ConvertType(out[1], new(bool)).(*bool)
	outstruct.IsCustom = *abi.ConvertType(out[2], new(bool)).(*bool)
	outstruct.CustomPrice = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
