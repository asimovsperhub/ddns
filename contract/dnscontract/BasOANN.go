...
// BasOANNMetaData contains all meta data concerning the BasOANN contract.
var BasOANNMetaData = &bind.MetaData{
...
// Deprecated: Use BasOANNMetaData.ABI instead.
var BasOANNABI = BasOANNMetaData.ABI
