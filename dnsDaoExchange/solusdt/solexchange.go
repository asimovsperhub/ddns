...
func NewClient(acct *ethacct.EthAccount) (*SolUSDTClient, error) {
	cli, err := ethclient.Dial(ethacct.InfuraPoint)
	if err != nil {
		return nil, err
	}
	return &SolUSDTClient{
		client: cli,
		acct:   acct,
	}, nil
}

func (euc *SolUSDTClient) Close() {
	euc.client.Close()
}
...
func (euc *SolUSDTClient) getLatest() (roundId *big.Int, err error) {
	var eu *udidc22.EthUsdt
	eu, err = udidc22.NewEthUsdt(common.HexToAddress(ethacct.SolUsdtContract), euc.client)
	if err != nil {
		//log.Println(err)
		return
	}
...
func (euc *SolUSDTClient) InsertExchange(
	roundId *big.Int,
	answer *big.Int,
	startedAt *big.Int,
	updatedAt *big.Int,
	...
	eu, err = udidc22.NewSolUSDT(common.HexToAddress(ethacct.SolUsdtContract), euc.client)
	if err != nil {
		//log.Println(err)
		return
	}
...
func (euc *SolUSDTClient) WaitTxReply() (err error) {
